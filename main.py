...
def likeRecommendation(user_id, coordinates):
    ...
    # print("Inside the Like Recommendation Function",recommendation_likes_car_ids)
    print("Len",len(recommendation_likes_car_ids))
    ...
    # unique_recommendation_likes_car_ids = unique_recommendation_likes_car_ids[:10]

def dislikeRecommendation(user_id, coordinates):
    ...
    # print("Inside the Dislike Function",recommendation_dislikes_car_ids)
    print("len",len(recommendation_dislikes_car_ids))
    ...
    # unique_recommendation_dislikes_car_ids = unique_recommendation_dislikes_car_ids[:10]
...
def FeedManagerMain(user_id, coordinates):
    ...
    recommended_car_pairs = feedCarId(user_id, coordinates)
